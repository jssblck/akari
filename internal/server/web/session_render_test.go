...
func TestSessionPageRendersSubagents(t *testing.T) {
	...
	html := renderComponent(t, SessionPage(p, d, msgs, FullTranscript(msgs), tools, nil, subs, HeaderStats{}, 0, false, true))
	...
	bare := renderComponent(t, SessionPage(p, d, msgs, FullTranscript(msgs), tools, nil, nil, HeaderStats{}, 0, false, true))
...
func TestToolCallDetailRendersOnChipAndOutline(t *testing.T) {
	p := Page{Title: "session", LoggedIn: true, Active: "sessions", Username: "jessoteric"}
	d, msgs, tools := sessionFixture()
	html := renderComponent(t, SessionPage(p, d, msgs, FullTranscript(msgs), tools, nil, nil, HeaderStats{}, 0, false, true))
	...
	bare := renderComponent(t, SessionPage(p, d, msgs, FullTranscript(msgs), bareTools, nil, nil, HeaderStats{}, 0, false, true))
...
func TestTranscriptRendersContextTurn(t *testing.T) {
	...
	html := renderComponent(t, SessionPage(p, d, msgs, FullTranscript(msgs), nil, nil, nil, HeaderStats{}, 0, false, true))
...
func TestSessionStatsFoldTokensAndDropLive(t *testing.T) {
	p := Page{Title: "session", LoggedIn: true, Active: "sessions", Username: "jessoteric"}
	d, msgs, tools := sessionFixture()
	html := renderComponent(t, SessionPage(p, d, msgs, FullTranscript(msgs), tools, nil, nil, HeaderStats{}, 0, true, true))
...
func TestSessionStatsTokensContext(t *testing.T) {
	...
	html := renderComponent(t, SessionPage(p, d, msgs, FullTranscript(msgs), tools, nil, nil, hs, 0, false, true))
...
func TestSessionQualityScoreArithmetic(t *testing.T) {
	...
	cleanHTML := renderComponent(t, SessionPage(p, d, msgs, FullTranscript(msgs), tools, nil, nil, clean, 0, false, true))
	...
	unscoredHTML := renderComponent(t, SessionPage(p, d, msgs, FullTranscript(msgs), tools, nil, nil, unscored, 0, false, true))
...
func TestSessionPageActionsGating(t *testing.T) {
	...
	adminHTML := renderComponent(t, SessionPage(admin, d, msgs, FullTranscript(msgs), tools, nil, nil, HeaderStats{}, 0, false, false))
	...
	viewerHTML := renderComponent(t, SessionPage(viewer, d, msgs, FullTranscript(msgs), tools, nil, nil, HeaderStats{}, 0, false, false))
